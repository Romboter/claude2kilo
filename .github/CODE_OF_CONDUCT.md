...
- Contributing constructively to discussions about the converter and development tools
- Providing helpful feedback on conversion issues and improvements
...
- **Bad faith contributions**: Deliberately submitting malformed or problematic content to waste maintainer time
...
- Be patient with users learning the conversion process
- Share knowledge about YAML, Go development, and conversion best practices

### Issue Reporting
- Use appropriate issue templates
- Provide sample files when reporting conversion problems
- Be respectful when describing bugs or limitations
